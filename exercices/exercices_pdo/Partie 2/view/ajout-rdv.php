...
<?php include '../control/ajout-rdv-controller.php' ?>
<!DOCTYPE html>
<html lang="fr" dir="ltr">
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Hopital LaManu - Ajout-Rendez-Vous</title>
...
<body>
    <div class="row">
        <div class="square col-md-8 offset-md-2">
            ...
            <form class="row mt-5" action="ajout-rdv.php" method="POST">
                ...
                <div class="form-group col-12 mx-auto">
                    ...
                    <p class="invalid"><?= isset($formErrors['patient']) ? $formErrors['patient'] : '' ?></p>
                </div>
                <button type="submit" name="submit" class="btn btn-primary mx-auto">Ajouter le RDV</button>
            </form>
        </div>
    </div>
